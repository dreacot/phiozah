...
<body>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="service-item">
							...
							<p>Sodales in est quis, blandit sollicitudin est. Nam ornare ipsum ac accumsan auctor. Donec
								con-sequat arcu et commodo interdum. </p>
						</div>
					</div> -->
				</div>
			</div>
	...
	<!-- Features section   -->
	<section class="features-section spad set-bg" data-setbg="img/features-bg.jpg" style="background: skyblue;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-6">
					<div class="feature-box text-center" style="border-top:4px solid orange;">
	...
	<section class="clients-section spad">
		<div class="container">
			<!-- <div class="client-text">
				<h2 style=" color: #333; font-weight: 900 ">Our Partners</h2>
			</div>
			<div id="client-carousel" class="client-slider owl-carousel" style="padding-bottom: 50px;">
