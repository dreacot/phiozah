		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					...
					<h2>About us</h2>
					<p>By leveraging on the collective expertise of our personnel and taking advantage of best practices
						across the industry, we are able to provide best-in-class services. </p>
			...
			">
				...
				<div class="col-lg-6">
					<div class="about-text">
						...
						<p>Phiozah Limited is a fast rising 100% Nigerian company, incorporated to
							be a leading provider of procurement & supply chain services, project management, engineering &
							engineering support services, offshore vessel support, Meet & Greet services and technical manpower supply in Nigerian
							and West African.</p>

						<p>By leveraging on the collective expertise of our personnel and taking advantage of best practices
							across the industry, we are able to provide best-in-class services.</p>

						<p>At Phiozah, we are strengthened by turnkey capabilities. Through our extensive network of strategic
							technical partnerships and alliances, we are better emplaced to respond quickly and efficiently to our
							clients’ needs. Our prompt and efficient services makes us unique and a service provider of choice.
						</p>
						<div class="about-sign">
							...
							<!-- <div class="sign-info">
								<h5>Princess Echefu</h5>
								<span>CEO Phiozah</span>
							</div> -->
						</div>
					</div>
				</div>
		...
		<div class="container text-white">
			<div class="row">
				...
				">
						...
						<div class="milestone-text">
							<h3 style="color: white;">Core Values</h3>
							<br>
							<br>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-widget about-widget">
						...
						<p>Phiozah Limited is a fast rising 100% Nigerian indigenous oil services company, incorporated
							...
							Engineering & Engineering support services, offshore vessel supportt, Meet & Greet services and technical manpower
