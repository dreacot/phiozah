		...
		<div class="site-navbar">
			...
			<nav class="site-nav-menu">
				<ul>
					...
					<li class="active"><a href="solutions.html">Our Services</a>
						<ul class="sub-menu">
							...
							<li><a href="solutions.html#section1">Technical Manpower Supply</a></li>
							<li><a href="solutions.html#section1">Meet & Greet Service</a></li>
						</ul>
					</li>
				...
				<div class="col-lg-12 col-md-6">
					<div class="service-item">
						...
						<p>Our meet and greet services are designed bearing in mind the
							need to provide ease and seamless airport to accommodation transition. We understand that arriving
				...
				<div class="col-lg-8">
					<div class="tab-content reserch-tab">
						...
						<div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
							...
							<p>With a highly skilled and experienced team and an outlook based firmly on global best practices,
								we are better emplaced to assist in projects of all sizes. Our comprehensive project management
								services include planning, execution, monitoring, reporting and close-out. We work closely with our clients to provide the most appropriate and effective service with clearly defined goals and objectives
							</p>
						</div>
						...
						<div class="tab-pane fade" id="tab-5" role="tabpanel" aria-labelledby="tab-5">
							<!-- <h2>We produce or supply Goods, & Services, Oils & Lubricants</h2> -->
							<p>Our meet and greet services are designed bearing in mind the need to provide ease and seamless
								airport to accommodation transition. We understand that arriving in foreign airports could be
								overwhelming, hence, we take the stress off our clients or their personnel/visitors as we ensure a
								smooth passage through immigration and baggage handling process.
							</p>

							<p>We ensure our clients enjoy a memorable and friendly welcome, powered by our meet and greet team.
								Knowing the power of first impression, we offer our them a lasting impression of ease and
								warm welcome. Our team is licensed by the Federal Aviation Authority of Nigeria and will
								meet you or your traveler(s) after you exit from the air-bridge and where applicable assist in
								ensuring smooth immigration clearance. When exiting, our team will ensure your exit is stress-free.</p>
				...
				<div class="row">
					...
					<div class="col-lg-7 order-1 order-lg-2 p-0">
						<ul class="footer-menu">
							<li><a href="index.html">Home</a></li>
							<li><a href="about.html">About us</a></li>
							<li class="active"><a href="Our Services.html">Our Services</a></li>
